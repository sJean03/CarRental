...
5. **vehicle_categories** - Small Car, Large Car, Exclusive Car
...
| Type | How It Works |
|------|--------------|
| **Percentage Share** | Owner gets 40% of rental income (example) |
...
1. **Owner payment:** Fixed monthly OR percentage share?
   - percentage share (60% for company RentEase, 40% for car owners)
2. **Deposits:** Required? What %?
   - Deposit, 30, nonrefundable (cancellation fee) - online payment
