...
-- Lisa's Car (1 car)
('60000000-0000-0000-0000-000000000009', '50000000-0000-0000-0000-000000000006', 'Toyota', 'Wigo', 2020, 'Yellow', 'YZA-4567', 'VIN001234567890009', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'manual', 'petrol', 4, 1200.00, 'Fun and affordable Toyota Wigo. Perfect for solo travelers and couples.', ARRAY['Air Conditioning', 'USB Port'], 'Must know manual transmission. No smoking.', ARRAY['https://images.unsplash.com/photo-1629215333654-bbaac0ee1323?w=800'], '44444444-4444-4444-4444-444444444444', 'owner_delivers', 'listed', 1, 4.5, NOW() - INTERVAL '4 days'),
...
('90000000-0000-0000-0000-000000000008', '80000000-0000-0000-0000-000000000009', 3960.00, 'credit_card', 'full', NULL, true, '1111', 'Visa', 'TXN-LIFECYCLE-001', 'completed', NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day'),
('90000000-0000-0000-0000-000000000009', '80000000-0000-0000-0000-00000000000a', 4950.00, 'credit_card', 'full', NULL, true, '2222', 'Mastercard', 'TXN-LIFECYCLE-002', 'completed', NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days'),
