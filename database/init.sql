...
-- Completed payments
('90000000-0000-0000-0000-000000000001', '80000000-0000-0000-0000-000000000001', 4950.00, 'credit_card', 'full', NULL, true, '1234', 'Visa', 'TXN-20251020-001', 'completed', NOW() - INTERVAL '8 days', NOW() - INTERVAL '8 days'),
...
('90000000-0000-0000-0000-000000000003', '80000000-0000-0000-0000-000000000003', 7040.00, 'credit_card', 'full', NULL, true, '9012', 'Visa', 'TXN-20251025-003', 'completed', NOW() - INTERVAL '4 days', NOW() - INTERVAL '4 days'),
('90000000-0000-0000-0000-000000000004', '80000000-0000-0000-0000-000000000004', 7920.00, 'credit_card', 'full', NULL, true, '3456', 'Mastercard', 'TXN-20251026-004', 'completed', NOW() - INTERVAL '3 days', NOW() - INTERVAL '3 days'),
...
('90000000-0000-0000-0000-000000000006', '80000000-0000-0000-0000-000000000006', 12100.00, 'credit_card', 'full', NULL, true, '2345', 'Amex', 'TXN-20251029-006', 'completed', NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day'),

-- Refunded payment
('90000000-0000-0000-0000-000000000007', '80000000-0000-0000-0000-000000000008', 19800.00, 'credit_card', 'full', NULL, true, '6789', 'Visa', 'TXN-20251024-007', 'refunded', NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days');
